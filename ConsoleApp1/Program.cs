...
namespace MSCDA5510
{
    class ContactGenerator
    {
        ...
        public ContactGenerator()
        {
            ...
            String outputFileName = @"/Users/sreerajpunnoli/git/MCDA5510_Assignments/ConsoleApp1/ConsoleApp1/customers.csv";
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                fileStream.Write(COMMA);
                fileStream.Write(GenerateStreetId());
        ...
        {
            String firstNames = @"/Users/sreerajpunnoli/git/MCDA5510_Assignments/ConsoleApp1/ConsoleApp1/firstNames.txt";
            return ReturnRandomLine(firstNames);
        }

        public string GenerateLastName()
        {
            String lastNames = @"/Users/sreerajpunnoli/git/MCDA5510_Assignments/ConsoleApp1/ConsoleApp1/lastNames.txt";
            return ReturnRandomLine(lastNames);
        }

        public string GenerateStreetName()
        {
            String streetName = @"/Users/sreerajpunnoli/git/MCDA5510_Assignments/ConsoleApp1/ConsoleApp1/streetName.txt";
            return ReturnRandomLine(streetName);
        }

        public string GenerateStreetId()
        {
            String streetId = @"/Users/sreerajpunnoli/git/MCDA5510_Assignments/ConsoleApp1/ConsoleApp1/streetId.txt";
            return ReturnRandomLine(streetId);
        }
