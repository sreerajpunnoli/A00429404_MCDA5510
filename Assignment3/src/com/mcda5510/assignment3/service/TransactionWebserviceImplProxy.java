...
public class TransactionWebserviceImplProxy implements com.mcda5510.assignment3.service.TransactionWebserviceImpl {
  ...
  public boolean updateTransaction(com.mcda5510.assignment3.entity.Transaction transaction){
    if (transactionWebserviceImpl == null)
      _initTransactionWebserviceImplProxy();
    return transactionWebserviceImpl.updateTransaction(transaction);
  }
  
  public com.mcda5510.assignment3.entity.Transaction getTransaction(int transactionId){
    if (transactionWebserviceImpl == null)
      _initTransactionWebserviceImplProxy();
  ...
  public boolean createTransaction(com.mcda5510.assignment3.entity.Transaction transaction){
    if (transactionWebserviceImpl == null)
      _initTransactionWebserviceImplProxy();
